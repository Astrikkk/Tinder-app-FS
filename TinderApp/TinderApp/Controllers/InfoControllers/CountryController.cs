...
namespace TinderApp.Controllers.InfoControllers
{
    ...
    public class CountryController : ControllerBase
    {
        ...
        public CountryController(TinderDbContext dbContext)
        {
        ...
        {
            var items = await _dbContext.Countries.ToListAsync();
            return Ok(items);
        }
        ...
        public async Task<IActionResult> Create([FromBody] CountryDto dto)
        {
            ...
            var newItem = new Country { Name = dto.Name };
            _dbContext.Countries.Add(newItem);
