                            ...
                            <div className="More-info">
                                <div className="More-info-item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="23" viewBox="0 0 20 23" fill="none">
                                        <path d="M10 9.29199C12.2091 9.29199 14 7.50113 14 5.29199C14 3.08285 12.2091 1.29199 10 1.29199C7.79086 1.29199 6 3.08285 6 5.29199C6 7.50113 7.79086 9.29199 10 9.29199Z" stroke="#B1A4A4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                        <path d="M19 21.292C19 16.3215 14.9705 12.292 10 12.292C5.0295 12.292 1 16.3215 1 21.292" stroke="#B1A4A4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                    </svg>
                                    <div className="prof-gender">{profile.gender?.name}</div>
                                </div>
                                <div className="More-info-item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="24" viewBox="0 0 18 24" fill="none">
                                        <path d="M9 22.292C9 22.292 17 15.992 17 9.16699C17 4.81789 13.4181 1.29199 9 1.29199C4.58187 1.29199 1 4.81789 1 9.16699C1 15.992 9 22.292 9 22.292Z" stroke="#B1A4A4" strokeWidth="2" strokeLinejoin="round"/>
