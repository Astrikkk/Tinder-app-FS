...
//import ChatImage from "./img/chat-image.svg";
...
const NewProfileViewer: React.FC = () => {
    ...
    const joinChatRoom = async (chatRoom: string) => {
        ...
        if (conn.state !== HubConnectionState.Connected) {
            ...
            await conn.start(); // Чекаємо підключення
        }
                        ...
                        <div className="Chat-Match">
                            <div className="Chats">
                                {userChats.map((chat, index) => (
                                    <button
                                        key={`${chat.chatRoom}-${index}`} // Додаємо `index` для уникнення дублікатів
                                        className="Chat-Item"
    ...
    return (
        <div className="custom-container">
            ...
            {loading ? (
                ...
                // Якщо обраний чат, рендеримо вікно чату
